...
public class IncidentTest {
    ...
    void testValidIncidentCreatedSuccessfully() {
        ...
        assertEquals("Accident rutier la intersecție", incident.title());
        assertEquals("Coliziune minoră între două autoturisme. Traficul este ușor îngreunat.", incident.description());
        assertEquals("testUser", incident.authorUsername());
