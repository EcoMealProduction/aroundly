package com.backend.domain.happening.old;
 ...
 */
public record OldIncident(
        @NonNull String title,
        @NonNull String description,
        List<Comment> comments,
        IncidentMetadata metadata,
        SentimentEngagement sentimentEngagement,
        EngagementStats engagementStats) implements OldHappening {
    ...
    public Builder toBuilder() {
        return new Builder()
                ...
                .metadata(metadata)
                .sentimentEngagement(sentimentEngagement)
                .incidentEngagementStats(engagementStats);
    }

    /**
     * Builder class for constructing {@link OldIncident} instances.
     * Inherits common builder logic from {@link OldHappening.Builder}.
     */
    public static class Builder extends OldHappening.Builder<Builder> {
        protected EngagementStats engagementStats;
         ...
         *
         * @param aEngagementStats the stats object to set.
         * @return this builder.
         */
        public Builder incidentEngagementStats(EngagementStats aEngagementStats) {
            this.engagementStats = aEngagementStats;
            return self();
        }

        /**
         * Constructs a new {@link OldIncident} using the current builder state.
         *
         * @return a new {@code Incident} instance.
         */
        @Override
        public OldIncident build() {
            return new OldIncident(
                    title,
                    description,
                    comments,
                    (IncidentMetadata) metadata,
    ...
    public boolean isDeleted() {
        return this.engagementStats().consecutiveDenies() >=3 || isExpired();
    }
     ...
     */
    public OldIncident confirmIncident() {
        final IncidentMetadata increasedExpirationTime = metadata.toBuilder()
                .expirationTime(metadata.expirationTime().plusMinutes(5))
                .build();

        final EngagementStats updatedEngagementStats = engagementStats.toBuilder()
                .confirms(engagementStats().confirms() + 1)
                .consecutiveDenies(0)
                .build();
     ...
     */
    public OldIncident denyIncident() {
        final EngagementStats updatedEngagementStats = engagementStats.toBuilder()
                .denies(engagementStats().denies() + 1)
                .consecutiveDenies(engagementStats.consecutiveDenies() + 1)
                .build();
     ...
     */
    @Override
    public OldIncident addComment(Comment comment) {
