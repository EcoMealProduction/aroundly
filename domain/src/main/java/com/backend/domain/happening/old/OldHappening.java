...
/**
 * Represents a generic reported occurrence within the application (e.g., an {@link OldIncident} or an {@link Event}).
 * This abstraction defines the common structure and behaviors for all reportable happenings in the system.
 */
public sealed interface OldHappening permits Event, OldIncident {
     ...
     */
    OldHappening addComment(Comment comment);
    ...
    /**
     * Abstract builder class for constructing immutable {@link OldHappening} instances.
